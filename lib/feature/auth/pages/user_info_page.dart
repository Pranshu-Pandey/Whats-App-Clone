...
import 'package:whatsapp_real/common/Widgets/short_h_bar.dart';
...
import 'package:whatsapp_real/feature/auth/pages/image_picker_page.dart';
...
class _UserInfoPageState extends ConsumerState<UserInfoPage> {
  ...
  saveUserDataToFirebase() {
    ...
    ref.read(AuthControllerProvider).saveuserInfoToFirebasestore(
        context: context,
        username: username,
        mounted: mounted,
